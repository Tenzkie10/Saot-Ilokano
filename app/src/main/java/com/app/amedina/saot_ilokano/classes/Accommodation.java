...
public class Accommodation extends AppCompatActivity implements RecyclerViewInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = findViewById(R.id.RVaccommodation);
        ctr=0;
    ...
    public void setGeneralContentModel() {
        ...
        cursor = dbHelper.getAllWordsByCategory("Accommodation");
        if(cursor!=null){
