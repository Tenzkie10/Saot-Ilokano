...
public class BasicGreetings extends AppCompatActivity implements RecyclerViewInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_basic_greetings);

        recyclerView = findViewById(R.id.RVbasicGreetings);
    ...
    public void setGeneralContentModel() {
        ...
        cursor = dbHelper.getAllWordsByCategory("Basic Greetings");
        if(cursor!=null){
