...
public class Complimentphrases extends AppCompatActivity implements RecyclerViewInterface {
ArrayList<GeneralConversationModel>generalConversationModel = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_complimentphrases);

        recyclerView = findViewById(R.id.RVcomplimentPhrases);
    ...
    public void setGeneralContentModel() {
        ...
        cursor = dbHelper.getAllWordsByCategory("Complimentary Phrases");
        if(cursor!=null){
