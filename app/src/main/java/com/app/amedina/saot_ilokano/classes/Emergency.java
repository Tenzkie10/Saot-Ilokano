...
public class Emergency extends AppCompatActivity implements RecyclerViewInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = findViewById(R.id.RVemergency);
    ...
    public void setGeneralContentModel() {
        ...
        cursor = dbHelper.getAllWordsByCategory("Emergency");
        if(cursor!=null){
