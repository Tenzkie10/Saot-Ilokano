...
public class GeneralConversation extends AppCompatActivity implements RecyclerViewInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_general_conversation);
        //imgFave = (ImageButton)findViewById(R.id.btnFavourite);
        recyclerView = findViewById(R.id.RVgenConvo);
        ctr=0;
    ...
    public void setGeneralContentModel() {
        ...
        cursor = dbHelper.getAllWordsByCategory("General Conversation");
        if(cursor!=null){
