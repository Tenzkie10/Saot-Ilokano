...
public class PeopleandFamily extends AppCompatActivity implements RecyclerViewInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_peopleand_family);

        recyclerView = findViewById(R.id.RVpeopleAndFamily);
    ...
    public void setGeneralContentModel() {
        ...
        cursor = dbHelper.getAllWordsByCategory("People and Family");
        if(cursor!=null){
