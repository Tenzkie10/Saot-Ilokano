...
public class Things extends AppCompatActivity implements RecyclerViewInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = findViewById(R.id.RVthings);
    ...
    public void setGeneralContentModel() {
        ...
        cursor = dbHelper.getAllWordsByCategory("Things");
        if(cursor!=null){
